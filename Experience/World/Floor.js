...
export default class Floor {
  ...
  setCircles() {
    ...
    const material = new THREE.MeshStandardMaterial({ color: 0xffa69e })
    const material2 = new THREE.MeshStandardMaterial({ color: 0x5e6472 })
    const material3 = new THREE.MeshStandardMaterial({ color: 0xaed9e0 })
