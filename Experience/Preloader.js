...
export default class Preloader extends EventEmitter {
  ...
  setAssets() {
    ...
    convert(document.querySelector('.second-main'))
  ...
  secondIntro() {
    return new Promise((resolve) => {
      ...
      this.secondTimeline
        ...
        .to(
          this.roomChildren.wall_accessories.scale,
          {
            x: 1,
            y: 1,
            z: 1,
        ...
        .to(
          this.roomChildren.night_lamp.scale,
          {
            x: 1,
            y: 1,
            z: 1,
        ...
        .set(this.roomChildren.mini_plane.scale, {
          x: 1,
          y: 1,
          z: 1,
        })
